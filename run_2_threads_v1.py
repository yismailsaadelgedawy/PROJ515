...
try:
    from thread_1_cam_v1 import detect_and_monitor
    from thread_2_spi_v1 import main as health_monitor_main
    DIRECT_IMPORT = True
except ImportError:
    DIRECT_IMPORT = False
...
def run_bee_monitor(args):
    ...
    if DIRECT_IMPORT:
        ...
        # Run as subprocess
        cmd = [sys.executable, "thread_1_cam_v1.py"]
...
def run_health_monitor():
    ...
    if DIRECT_IMPORT:
        ...
        # Run as subprocess
        cmd = [sys.executable, "thread_2_spi_v1.py"]
        try:
